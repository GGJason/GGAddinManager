...
namespace GGJason
{
    ...
    public class GGAddin : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButton pushButton = ribbonPanel.AddItem(new PushButtonData("Addin Manager mad by GGJason. Visit http://revit.ggjason.tw for more infomation.", "Manage", path+@"\GGAddinManager.dll", "GGJason.guid")) as PushButton;
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    public class guid : IExternalCommand
    {
        public Result Execute(ExternalCommandData data, ref string msg, ElementSet elements)
        {
            DisplayForm form = new DisplayForm(data,ref msg,elements);
            form.Show();
            return Result.Succeeded;
